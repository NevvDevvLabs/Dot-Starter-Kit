// Define the platform values as a const object
export const SubstrateWalletPlatform = {
  Browser: "browser",
  Android: "Android OS",
  iOS: "iOS",
} as const;

// Create a union type from the object values
export type SubstrateWalletPlatform =
  (typeof SubstrateWalletPlatform)[keyof typeof SubstrateWalletPlatform];
